...
Welcome to ``pandas-xlsx-tables`` contributor's guide.
...
If you experience bugs or general issues with ``pandas-xlsx-tables``, please have a look
...
You can help improve ``pandas-xlsx-tables`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pandas-xlsx-tables`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pandas-xlsx-tables``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pandas-xlsx-tables.git
    cd pandas-xlsx-tables
...
#. Install |pre-commit|_::
   ...
   ``pandas-xlsx-tables`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pandas-xlsx-tables
.. _issue tracker: https://github.com/<USERNAME>/pandas-xlsx-tables/issues
.. <-- end -->
